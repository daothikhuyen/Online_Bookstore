    ...
    <form action="" method="POST">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <textarea name="description"  class="form-control" id="description" cols="30" rows="5">{{ $menu->description }}</textarea>

            </div>
            <div class="form-group">
                <label for="exampleInputFile">Mô tả chi tiết</label>
                <textarea name="content" class="form-control" id="content" cols="30" rows="5">{{ $menu->content }}</textarea>
            ...
            <div class="form-check">
                ...
                <div class="form-group">
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" id="customRadio1" name="active" value="1" {{ $menu->active == 1?'checked':''}} >
                        <label for="customRadio1" class="custom-control-label">Có</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" id="customRadio2" name="active" value="0" {{ $menu->active == 0?'checked':''}}>
